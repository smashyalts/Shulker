...
pub static TEST_SERVER: LazyLock<MinecraftServer> = LazyLock::new(|| MinecraftServer {
    metadata: ObjectMeta {
    ...
    spec: MinecraftServerSpec {
        ...
        config: MinecraftServerConfigurationSpec {
            ...
            lifecycle_strategy: MinecraftServerConfigurationLifecycleStrategy::AllocateWhenNotEmpty,
